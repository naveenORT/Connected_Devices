...
class MultiActuatorAdaptor():
    ...
    def humidity_api_act(self):    
        if (humidity_data_object.getActuationStae() is True):
                ...
                humidity_actuator_status.addData("api_inbound", humidity_data_object.getcurvalue(), "Humidity Sensor")  # logging actuator data
                api_message = SimpleLedActivator(10)
    ...
    def humidity_i2c_act(self):    
        if  (i2c_data_object.getActuationStae() is True):
                ...
                i2c_actuator_status.addData("i2c_inbound", i2c_data_object.getcurvalue(), "Humidity Sensor")  # logging actuator data
